...
<xsl:stylesheet version="1.0"
                ...
                extension-element-prefixes="fox">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                <fo:simple-page-master master-name="firstPage"
                    ...
                    <fo:region-after region-name="xsl-region-after-firstPage" extent="5.5cm"/>
            ...
            <fo:page-sequence master-reference="firstPage" initial-page-number="1">
                ...
                <fo:static-content flow-name="xsl-region-after-firstPage">
                    <!-- 1) Bank-details | Invoice-summary | QR -->
                    <fo:table
                            width="100%"
                            table-layout="fixed"
                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell vertical-align="top">
                                    <fo:table
                                        ...
                                        <fo:table-body>
                                            <fo:table-row>
                                                <fo:table-cell background-color="#E0E0E0" padding="3pt" border-right="1.5pt solid black">
                                                    <fo:block font-weight="bold">Bank Name:</fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell padding="3pt">
                                                    <fo:block>Barclays Bank</fo:block>
                                                </fo:table-cell>
                                            </fo:table-row>
                                            <fo:table-row border-top="1.5pt solid black">
                                                <fo:table-cell background-color="#E0E0E0" padding="3pt" border-right="1.5pt solid black">
                                                    <fo:block font-weight="bold">Bank Address:</fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell padding="3pt">
                                                    <fo:block>Hatch Str, Dublin</fo:block>
                                                </fo:table-cell>
                                            </fo:table-row>
                                            <fo:table-row border-top="1.5pt solid black">
                                                <fo:table-cell background-color="#E0E0E0" padding="3pt" border-right="1.5pt solid black">
                                            ...
                                            <fo:table-row border-top="1.5pt solid black">
                                                ...
                                                <fo:table-cell padding="3pt">
                                                    <fo:block>DHL Express Ireland Ltd</fo:block>
                                                </fo:table-cell>
                                            </fo:table-row>
                                            <fo:table-row border-top="1.5pt solid black">
                                                <fo:table-cell background-color="#E0E0E0" padding="3pt" border-right="1.5pt solid black">
                                                    <fo:block font-weight="bold">IBAN Code:</fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell padding="3pt">
                                                    <fo:block>IE15BARC99021244284401</fo:block>
                                                </fo:table-cell>
                                            </fo:table-row>
                                            <fo:table-row border-top="1.5pt solid black">
                                                <fo:table-cell background-color="#E0E0E0" padding="3pt" border-right="1.5pt solid black">
                                                    <fo:block font-weight="bold">Swift Code:</fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell padding="3pt">
                                                    <fo:block>BARCIE2D</fo:block>
                                                </fo:table-cell>
                                            </fo:table-row>
                                        </fo:table-body>
                                    </fo:table>
                                ...
                                <fo:table-cell text-align="center" vertical-align="top">
                                    <fo:table
                                        ...
                                        <fo:table-body>
                                            <fo:table-row>
                                                <fo:table-cell padding="3pt" border-right="1.5pt solid black">
                    ...
                    <!-- 2) Remittance footer -->
                    <xsl:call-template name="remittanceFooter"/>
                </fo:static-content>
